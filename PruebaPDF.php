...
$fecha_reporte = date("Dd-m-Y");
    ...
    $this->Cell(110,10,'INGRESO DE PERSONAS QUE NO SON APRENDICES ENTRE',10,10,'C');
    $this->Cell(40,10,$fecha_hora_entrada,0,0,'C');
    $this->Cell(10,10,'Y',0,0,'C');

    $this->Cell(40,10,$fecha_hora_salida,0,0,'C');
    $this->Ln(10);
...
$consulta = "SELECT usuario.doc_usuario, usuario.cargo, usuario.nombre, usuario.apellido, usuario.sexo, registro.fecha_hora_entrada from usuario,registro
        where usuario.cargo<>'Aprendiz' and registro.fecha_hora_entrada BETWEEN '$fecha_hora_entrada' AND '$fecha_hora_salida' and usuario.doc_usuario=registro.doc_usuario";
