<?php
	...
	$sentencia_select=$cone-> prepare('SELECT * FROM espacio ORDER BY cod_espacio DESC'); //Prepara una sentencia para su ejecución y devuelve un objeto sentencia
	...
	if(isset($_POST['btn_buscar'])){
		...
		$select_buscar=$cone->prepare('
			SELECT *FROM formacion WHERE cod_formacion LIKE :campo ;'
		);
...
<div class="datatable-container">
                        <div class="header-tools">
							<div class="search">
								<form  method="post">
                                    <input type="text" name="buscar" placeholder="Código"
                                ...
                                onclick="javascript:window.location='Form_espacios.php';" value="Volver">
							</div>            
                </div>
                                ...
                                <table class="datatable">
									...
									<?php foreach($resultado as $fila):?>
										<tr>
										<td><?php echo $fila['cod_espacio']; ?></td>
										<td><?php echo $fila['nombre']; ?></td>
										<td><a href="update_espacios.php?cod_espacio=<?php echo $fila['cod_espacio']; ?>"><center><i class="material-icons">edit</i></center></a></td>
										<td><a href="delete_espacios.php?cod_espacio=<?php echo $fila['cod_espacio']; ?>"><center><i class="material-icons">delete</i></center></a></td>
									</tr>
										<?php endforeach ?>
