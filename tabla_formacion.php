<?php
	...
	$sentencia_select=$cone-> prepare('SELECT * FROM formacion ORDER BY cod_formacion DESC'); //Prepara una sentencia para su ejecución y devuelve un objeto sentencia
...
<div class="datatable-container">
                        <div class="header-tools">
							<div class="search">
                                ...
                                onclick="javascript:window.location='Form_formacion.php';" value="Volver">
							</div>            
                </div>
                                ...
                                <table class="datatable">
									...
									<?php foreach($resultado as $fila):?>
										...
										<td><a href="update_formacion.php?cod_formacion=<?php echo $fila['cod_formacion']; ?>"><center><i class="material-icons">edit</i></center></a></td>
										<td><a href="delete_formacion.php?cod_formacion=<?php echo $fila['cod_formacion']; ?>""><center><i class="material-icons">delete</i></center></a></td>
									</tr>
										<?php endforeach ?>
