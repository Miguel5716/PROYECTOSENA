...
$fecha_reporte = date("Dd-m-Y");
    ...
    $this->Cell(40);
    $this->Cell(80,10,'PERMISOS QUE SOLICITARON ENTRE ',0,0,'C');
    $this->Ln(10);
...
$consulta = "SELECT usuario.doc_usuario, usuario.cargo, usuario.nombre, usuario.apellido, usuario.sexo, permisos.fech_per from usuario,permisos
...
while ($row=$resultado->fetch_assoc()) {
    ...
    $pdf->Cell(40,10,$row['fech_per'],1,1,'C',0);
