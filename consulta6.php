...
<div class="sidenav">
	...
	PERSONAS QUE INGRESARON POR GENERO
		...
		<form action="Consulta6PDF.php" method="POST">
	<br>
	...
	<br>
	<br>
    <input type="submit" name="enviar" class="btn btn-black" value="HOMBRES">
	</form><br>
        <form action="Consulta6MPDF.php" method="POST">
            <br>
    <input type="text" class="form-control" placeholder="Fecha hora entrada" name="fecha_hora_entrada" onfocus="this.type='datetime-local'" required>
    <br>
    <input type="text" name="fecha_hora_salida" class="form-control" placeholder="Fecha hora salida" onfocus="this.type='datetime-local'" required>
    <br>
    <br>
    <input type="submit" name="enviar" class="btn btn-black" value="MUJERES">
    </form><br>
        <form action="Consulta6OPDF.php" method="POST">
            <br>
    <input type="text" class="form-control" placeholder="Fecha hora entrada" name="fecha_hora_entrada" onfocus="this.type='datetime-local'" required>
    <br>
    <input type="text" name="fecha_hora_salida" class="form-control" placeholder="Fecha hora salida" onfocus="this.type='datetime-local'" required>
    <br>
    <br>
    <input type="submit" name="enviar" class="btn btn-black" value="OTROS">
</form>
	...
	$fecha_hora_salida =($_POST['fecha_hora_salida']);
		...
		$consulta4="SELECT usuario.doc_usuario, usuario.cargo, usuario.nombre, usuario.apellido, usuario.sexo, registro.fecha_hora_entrada from usuario,registro
        where usuario.doc_usuario=registro.doc_usuario and registro.fecha_hora_entrada BETWEEN '$fecha_hora_entrada' AND '$fecha_hora_salida'
        and usuario.sexo=('M')" ;
